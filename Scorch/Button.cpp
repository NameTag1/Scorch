...
, mSprite()
, mText("", fonts.get(Fonts::Main), Settings::FontSizeM)
, mIsToggle(false)
{
...
void Button::updateRect(sf::FloatRect parentRect)
{
	Component::updateRect(parentRect);
	mRect.scaleSprite(mSprite);

	mText.setCharacterSize(Settings::FontSizeM);
